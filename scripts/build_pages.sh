...
// iOS Safari blocks audio until a user gesture. Pyxel shows its own "touch to start"
// prompt; on that tap/click, resume the underlying SDL2 AudioContext if needed.
